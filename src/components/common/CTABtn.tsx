...
export const CTABtn = ({
  ...
  return (
    <Link
      ...
      target={target}
      className={
        "mt-4  flex items-center gap-10   px-4 py-2 group uppercase text-xs font-bold bg-custom-blue hover:text-black hover:bg-white text-white rounded  transition-colors duration-300 " +
        className
      }
    >
      {title}
